...
type TaskServiceClient interface {
	...
	DeleteTask(ctx context.Context, in *GetTaskRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *taskServiceClient) DeleteTask(ctx context.Context, in *GetTaskRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type TaskServiceServer interface {
	...
	DeleteTask(context.Context, *GetTaskRequest) (*Empty, error)
...
func (UnimplementedTaskServiceServer) DeleteTask(context.Context, *GetTaskRequest) (*Empty, error) {
